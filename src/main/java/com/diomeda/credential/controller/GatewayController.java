...
import com.diomeda.credential.util.ContentRequestTransformer;
import com.diomeda.credential.util.HeadersRequestTransformer;
import com.diomeda.credential.util.URLRequestTransformer;
...
public class GatewayController {
  ...
  @ResponseBody
  public ResponseEntity<String> proxyRequest(HttpServletRequest request) throws Exception, IOException, URISyntaxException {
  ...
  private HttpUriRequest createHttpUriRequest(HttpServletRequest request) throws Exception, URISyntaxException, IOException {
